...
<body>
	...
	<div class="loginWraper">
		<div id="loginform" class="loginBox">
			...
			<form class="form form-horizontal" method="post" action="/goLogin">
				<div class="row cl">
					<font class="social-login" ></font> 
					<label
						class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60d;</i></label>
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8">
						<input id="password" name="password" type="password"
							placeholder="密码" value="123" class="input-text size-L">
					</div>
				</div>
				<div class="row cl">
					<div class="formControls col-xs-8 col-xs-offset-3">
						<input class="input-text size-L" type="text" placeholder="验证码"
							name="ValidateCode"  style="width: 235px;">
							 <img id="img" src="${pageContext.request.contextPath}/getValidateCode"></img>
  ...
  function changeImg(){
        ...
        img.src = "${pageContext.request.contextPath}/getValidateCode?date=" + new Date();
    }
</script>
